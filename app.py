...
st.image("https://github.com/justinxtsui/Index-chart-maker/blob/main/Beauhurst%20Insights%20Logo.png?raw=true", use_container_width=True)

st.markdown('<h1 class="app-title">Dex-ter by JT </h1>', unsafe_allow_html=True)
st.markdown('<p class="app-subtitle">Turn exports into indexed time series charts (For internal use only)</p>', unsafe_allow_html=True)
